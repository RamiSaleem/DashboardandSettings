...
public class Change_country implements SauceOnDemandSessionIdProvider, SauceOnDemandAuthenticationProvider {
    ...
    @Test
    public void Change_country() throws Exception {
        ...
        Assert.assertEquals(country, "Lebanon");
